...
- **Impulso Oficial (Oficialidade):** O processo pode ser iniciado pela própria chefia de ofício (sem provocação) e deve ser tocado para a frente pela Administração automaticamente, sem depender de pedidos constantes das partes. 
	- Processos que buscam a concessão de direitos específicos ao cidadão dependem de provocação da parte interessada para serem iniciados. 
- **Formalismo Moderado:** Dispensa o excesso de formalidades, sacramentos e burocracias inúteis que impeçam o cidadão de exercer seus direitos. 
- **Gratuidade Processual:** É vedada a cobrança de taxas, custas ou valores para a interposição de recursos administrativos, a menos que haja previsão expressa em lei. 
	- Essa gratuidade cobre o "direito de petição". Contudo, a Administração pode cobrar os custos materiais de reprodução de documentos.

Existe uma oposição que as bancas invertem sistematicamente:
- **No Processo Judicial**, vigora predominantemente a **Verdade Formal**: a regra máxima é "o que não está nos autos do processo, não está no mundo".
...
**Ciclo de vida gestão de processos**
1. **Modelagem Situação Atual (AS-IS)**: Levantamento que desenha o processo exatamente como ele funciona na realidade hoje.
2. **Análise de Processos**: O objetivo é descobrir "gargalos", redundâncias e atividades que não agregam valor ao processo.
3. **Desenho Situação Futura (TO-BE)**: Trata-se do projeto de redesenho do processo ideal. Este modelo contém as melhorias, automações digitais e simplificações.
4. **Monitoramento e Controle**: Após a implantação do TO-BE, utilizam-se os Indicadores de Desempenho (KPIs) como instrumentos métricos para avaliar se o processo redesenhado está cumprindo as metas de eficiência estabelecidas.

**3's KPIs:** As métricas de avaliação são divididas em três categorias clássicas.
