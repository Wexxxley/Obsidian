...
**Método da ponderação/hormonização:** Utilizado quando a conflito entre Técnica interpretativa utilizada para solucionar conflitos entre princípios jurídicos no caso concreto. O aplicador do direito avalia o peso de cada princípio na situação específica, buscando equilibrá-los para proteger um valor constitucional com o menor sacrifício possível do princípio contraposto.
