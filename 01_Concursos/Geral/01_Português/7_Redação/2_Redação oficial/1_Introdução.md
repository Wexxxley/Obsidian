...
**Clareza**:  
1. Utilizar palavras e expressões simples.
	**Exceção**: quando o texto versar sobre assunto técnico.
2. usar frases curtas, bem estruturadas; apresentar as orações na ordem direta.
	**Exceção**: para evitar ambiguidade.
3. buscar a uniformidade do tempo verbal.
4. não utilizar regionalismos e neologismos;
5. pontuar adequadamente o texto;
6. explicitar o significado da sigla na primeira referência a ela;
7. utilizar palavras e expressões em outro idioma apenas quando indispensáveis e em itálico.

**Precisão**:
A precisão é a articulação adequada da linguagem, sem ambiguidade ou sinônimos meramente
estilísticos. Os textos devem ser objeto de **revisão** e a linguagem técnica esclarecida.

**Objetividade**
Ser objetivo é ir diretamente ao assunto que se deseja abordar, sem prolixidade. Todo texto possui ideias fundamentais e secundárias. As secundárias podem esclarecer o sentido daquelas,
