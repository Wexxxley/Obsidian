...
>[!tip]
>1. Veja a transitividade do verbo (tem que ser VTD e VTDI)
>2. Passe para a analítica.
- Venderam-**se** os apartamentos - Os apartamentos foram vendidos
...
- O candidato cortou-**se** com o papel. (Objeto Direto).
- Luiza já **se** preparou (Objeto direto)
- Ele arrogou-**se** o direito de falar. (Objeto Indireto).      
...
Ocorre quando o "se" acompanha os chamados **verbos pronominais**, que são aqueles que não podem ser conjugados sem a presença do pronome. [6_Verbos pronominais](../3_Verbos/6_Verbos%20pronominais.md)
...
- Passaram-se os anos e ele não voltou. -> Passaram os anos e ele não voltou.
- O tempo foi-se rapidamente. -> O tempo foi rapidamente

**7. Conjunção Subordinativa Integrante**
Ocorre quando o "se" introduz uma Oração Subordinada Substantiva
- Não sei se a prova será adiada.
- Perguntei se ele estava pronto. 

**8. Conjunção Subordinativa Condicional**
**Hipótese**
- Se você estudar a norma-padrão, passará no concurso.

**9. Conjunção Subordinativa Causal**
**Fato**. Pode ser substituído pelas conjunções "já que", "visto que" ou "como".
- Se ele não estudou para o concurso, não deveria reclamar da nota. 
- Se ele preparou-se, não há que ficar inseguro

**10. Conjunção subordinativa Concessiva**
Pode ser substituido por embora
- Se o bebê dormiu a noite inteira, os pais ainda estão acordados.
