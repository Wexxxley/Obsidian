...
Uma redação dissertativo-argumentativa é um gênero textual com dois objetivos: expor informações sobre um determinado assunto (dissertar) e defender um ponto de vista específico sobre ele (argumentar). O objetivo central desse formato é persuadir o leitor da validade de uma tese (ideia central ou posicionamento do autor). 
...
- **Opção 3:** Desa forma, é fundamental ressaltar a importância do [TEMA], bem como denunciar a [CAUSA] como o principal entrave para a superação desse quadro.
