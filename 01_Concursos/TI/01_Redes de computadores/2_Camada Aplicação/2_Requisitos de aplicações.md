...
___
Algumas aplicações podem funcionar melhor de acordo com o protocolo da camada de transporte utilizado.

- Algumas aplicações (como áudios em tempo real) podem tolerar **perda de dados**. Outras (como a transferência de arquivos) exigem transferência 100% confiável.

- Algumas aplicações (telefonia) são **sensíveis ao atraso** e exigem baixos atrasos para serem efetivos.
...
- TCP é ótimo para downloads, emails e páginas web.
