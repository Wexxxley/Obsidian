...
**RPI (Revista da Propriedade Industrial)**: É o veículo oficial de comunicação do INPI. Tudo o que acontece em um processo só passa a ter validade legal após ser publicado na RPI. É publicada todas as terças-feiras A revista é dividida em seções. A seção de **Marcas** é a mais relevante. Nela, aparecem todos os despachos da semana anterior, como:    
- **Publicação de Pedido:** Abre o prazo de 60 dias para que terceiros apresentem oposição.        
- **Deferimento/Indeferimento:** A decisão final do técnico do INPI sobre o registro.     
