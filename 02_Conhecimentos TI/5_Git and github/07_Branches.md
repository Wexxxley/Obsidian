...
**Mas o que é uma branch?** A analogia mais fácil é a de uma árvore: você tem o tronco principal (`main`) e pode criar novos galhos (`branches`) que saem dele. Esses galhos são as ramificações do seu projeto.
        
**Por que usar branches?** Para isolar o desenvolvimento. 
