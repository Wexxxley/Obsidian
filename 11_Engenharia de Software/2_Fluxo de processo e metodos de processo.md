...
#### **2.1 Modelos de Processo Evolucionário**
- Os dois modelos mais comuns de processos evolucionários são: Prototipação e Modelo Espiral.
##### **2.1.1 Prototipação**
...
- É feito uma entrega inicial rápida e depois (2/3 meses) a versão final
