...
---
Engenharia de Software trata da ==aplicação de abordagens sistemáticas, disciplinadas e quantificáveis para desenvolver, operar, manter e evoluir software.== Ou seja, Engenh ES é a área da Computação que se preocupa em aplicar princípios de engenharia na construção de software.
