...
___
Álgumas aplicações podem funcionar melhor de acordo com o protocolo da camada de transporte utilizado.
...
- Algumas aplicações (como telefonia, jogos interativos) são **sensíveis ao atraso** e exigem baixos atrasos para serem “efetivos”.
