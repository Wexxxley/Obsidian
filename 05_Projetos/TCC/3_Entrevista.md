...
- O seu pet faz uso de alguma medicação de uso contínuo? Se sim, você consideraria útil que o sistema possuísse notificasse o cuidador nos horários exatos definidos por você?
    - Para o match entre pet e cuidador.
### 1.2 Fluxos de Emergência Médica
...
### 1.3 Diário de Estadia e Expectativas de Monitoramento
...
- Caso contrate o serviço, você teria preferência por entregar o pet presencialmente na residência do cuidador, ou a plataforma deve permitir a negociação de uma taxa extra de transporte para o cuidador buscar o animal na sua residência?
...
- O aplicativo exigirá o envio de fotos e vídeos para manter o tutor informado, qual seria a frequência máxima de envios obrigatórios por dia que você conseguiria cumprir sem achar o aplicativo invasivo?
...
- Quais seriam seus maiores impeditivos para prestar esse tipo de serviço?