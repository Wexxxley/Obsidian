...
- Primeiro é inicializado o conjunto A, onde será armazenado as arestas da árvore geradora mínima. 
    
- Depois são criadas |V| árvores, cada uma com um vértice. 
...
- Do contrário, os dois vértices pertencem a árvores diferentes. Nesse caso, a linha 7 adiciona a aresta a A.
    
- A linha 8 une os dois conjuntos que possuem u e v. O algoritmo utiliza a estrutura **conjuntos disjuntos** para representar a floresta. 
