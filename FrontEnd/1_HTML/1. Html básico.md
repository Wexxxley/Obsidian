...
---
 ...
 Html é a linguagem de ==marcação== usada para estruturar páginas web, criando elementos de texto, inserindo imagens e listas, ou seja, é responsável pelo conteúdo do site.

**Tags**: As tags são os blocos fundamentais do HTML, e cada tag serve para indicar um tipo específico de conteúdo ou estrutura na página. Uma tag  geralmente é composta por:
- Tag de abertura
- Conteúdo
- Tag de fechamento

As tags são usadas para que o navegador consiga diferenciar os elementos do site. O que é um parágrafo, um  título, subtítulo etc.
...
Imagem com link:
![](https://lh7-rt.googleusercontent.com/docsz/AD_4nXdSVqshDz_BydEQImI8lBNEHOGlrXEcTenUjhhDP3ytcLSB5gDuCntpItdpVgUyka7-Aq1TXHpe5rRONzcSyEShVanQHN3a-FwolBN4pJvzlOIf51498tvHT6D9Thn9-aggJ5jb?key=VYJVAqKhTdZyHt8enJbiwA)
...
**src**: é onde fica a localização da imagem.
**alt**: é um texto que descreve a imagem para fins de acessibilidade. 
...
- ``<q>``: Usada para citações curtas dentro de uma linha de texto.
- ``<abbr>``: Usada para abreviações ou siglas, com explicação completa. O title mostra o significado ao passar o mouse.
...
- ``<pre>``: Usada para mostrar texto com formatação preservada.Tudo é exibido exatamente como foi digitado no código-fonte.
