...
- **Client Stub**: Um procedimento executado no cliente. Sua única função é empacotar os argumentos em uma mensagem de requisição e enviá-la ao servidor. Em seguida, ele espera pela resposta, desempacota os resultados e os retorna ao programa cliente.
...
- **Despachante**: Recebe a mensagem de requisição, examina o identificador do procedimento e chama o server stub.
    
- **Server stub**: Sua função é desempacotar os argumentos da mensagem, chamar a implementação e, em seguida, empacotar os resultados em uma mensagem de resposta para enviar de volta ao cliente.
