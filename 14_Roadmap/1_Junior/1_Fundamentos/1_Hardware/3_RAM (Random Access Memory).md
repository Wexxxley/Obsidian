...
- Quando você abre um programa (navegador) ou um arquivo (uma foto), o computador copia esse programa/arquivo do armazenamento principal (HD ou SSD) para a RAM.
...
- Isso significa que ela só consegue manter os dados enquanto estiver recebendo energia (enquanto o computador estiver ligado ou com bateria). No momento em que você desliga o computador, tudo o que estava na RAM é apagado.
