...
- Ram é a memória de **curto prazo** e **alta velocidade** do computador. Ela armazena temporariamente todos os dados que estão sendo usados no momento.
    
- Quando você abre um programa ou um arquivo, o computador copia esse programa/arquivo do armazenamento principal (HD ou SSD) para a RAM.
...
- Isso significa que ela só consegue manter os dados enquanto estiver recebendo energia. No momento em que você desliga o computador, tudo o que estava na RAM é apagado.
...
- Com mais RAM você pode manter muitos programas e arquivos abertos ao mesmo tempo, prontos para uso imediato pela CPU, sem lentidão.