## **NPM, Gerenciamento de Dependências e Resolução**
...
Neste módulo, analisaremos a estrutura do manifesto do projeto e como o Node.js resolve dependências no sistema de arquivos.

---

### **1. O Manifesto: `package.json`**

O arquivo `package.json` é a raiz de qualquer projeto Node.js. Ele define metadados, scripts de automação e listas de dependências.
