...
**Como resolver?** O Git insere marcadores especiais no arquivo conflitante para mostrar onde está o problema.
    ...
    >>>>>>>: O fim do código que está na branch que você quer mesclar.
        
**Seu trabalho é:**
1. Abrir o arquivo.
2. Editar o arquivo manualmente, remover todos os marcadores. 
3. Decidir qual código deve ficar (o seu? o do outro? uma combinação dos dois?).
4. Salvar o arquivo.
5. Fazer um novo commit para finalizar a resolução.
...
- **Caso 1: Você acabou de fazer o commit e só quer corrigir.
    ...
    - Faça a correção no código -> rode `git add .` -> rode `git commit --amend`.
