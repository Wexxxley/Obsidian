...
- Primeiro, você precisa ir ao site do GitHub e criar um novo repositório. 

**2. Linkando seu Repositório Local ao Remoto**
- O GitHub lhe dará a URL do seu repositório.    
...
- Sempre execute `git pull` para obter as últimas mudanças antes de tentar fazer `git push` das suas próprias mudanças.    
