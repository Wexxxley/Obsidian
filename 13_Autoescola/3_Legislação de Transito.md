...
Quando uma pista de rolamento comporta várias faixas de circulação no mesmo sentido: 
...
1. **Via de Trânsito Rápido:** Caracterizada por acessos especiais, sem semáforos e sem acesso direto a lotes lindeiros (prédios, casas).
