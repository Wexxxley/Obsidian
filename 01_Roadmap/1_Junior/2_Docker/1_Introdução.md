...
git checkout 2e
```
#### 1.4.5 Lembrando os comandos de limpeza (Página 14)

O Docker não limpa automaticamente contêineres ou imagens.

- Para limpar tudo ao final de cada capítulo (remove todos os contêineres):
