...
1. **Docker Engine:** É o processo que roda em segundo plano. Ele gerencia tudo: o cache local de imagens, os contêineres ativos, as redes virtuais e os volumes. O Engine expõe todas as suas funcionalidades através de uma API.
