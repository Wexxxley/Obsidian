...
- O cliente de "Bruno", por sua vez, foi programado (main_html.js) para checar sua fila a cada 2 segundos. Isso é o setInterval que chama rmi_get_updates(token).
- Esse processo de checagem é chamado de **Polling**.     

---
#### **1. send_request(...)**

- **O que faz:** O usuário "A" (requester) envia um pedido de amizade para o usuário "B".
...
- **Resultado:** Na próxima vez que o cliente de "B" chamar get_updates, ele receberá esse evento.
