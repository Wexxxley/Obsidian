...
**Servidor de nomes local:** Sua função é processar a consulta do hospedeiro requisitante. Ele atua como um intermediário. Por padrão, o Servidor de Nomes Local é definida pelo ISP.
