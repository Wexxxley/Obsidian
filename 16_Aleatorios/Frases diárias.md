...
---
Nosso projeto é o Observatório legislativo. Nos percebemos a dificuldade que é acessar e conseguir informaçoes uteis do site da câmara, isso é um padrão para esses dados abertos, normalmente as informações estao dispostas de forma complexa e fragmentada. 

Normalmente para conseguir retirar informações úteis desses sites você não pode ser leigo no assunto, se não você você vai se frustrar ao tentar navegar pelo site.
...
As maiores dores dos usuários foram:
